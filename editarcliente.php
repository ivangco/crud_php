...
$sql="SELECT * FROM `clientes` WHERE id_cliente=$_GET[cod]";
...
<body>
    ...
    <section class="row m-0 bg-white justify-content-center align-items-center vh-100">
        <div class="col-sm-8 bg-white">
            ...
            <!--formulario-->
            <form class="container-fluid center-block bg-white " action="modificarcliente.php" method="GET">
                <div class="row">
