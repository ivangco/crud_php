...
FROM venta,clientes
where venta.estado_venta='PENDIENTE' AND venta.id_cliente=clientes.id_cliente;");

if (mysqli_num_rows($consulta) > 0) {
    $row = mysqli_fetch_array($consulta);
    $ultimoid = $row['id_venta'];
}
...
<body onLoad="getTime()">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="FacturarVentas.php">Factura</a>
                </li>
    ...
    <div class="container-fluid">
        ...
        <div>
            <form action="cargarventa.php" enctype="multipart/form-data" method="POST" role="form"
                class="form-horizontal form-groups-bordered" >

                <h3><i class=""></i>Ventas de Articulos</h3><br>
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-border panel-warning widget-s-1">
                                    <div class="panel-heading">
                                        <h4 class="mb"><i class="fa fa-archive"></i> <strong>Detalle De Venta</strong>
                                        </h4>
                                    </div>
...
FROM ventadetalle,productos
where productos.id_producto=ventadetalle.id_producto and ventadetalle.id_venta='$row[id_venta]';");
...
while ($rows = mysqli_fetch_array($consultadetalle)) {
    ...
    ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div align="center">
                                                                        <?php echo $rows['precio_venta']; ?></div>
                                                                </td>
                                                                <td>
                                                                    <div align="center">
                                                                        <?php echo $rows['cantidad_venta']; ?></div>
                                                                </td>
                                                                <td>
                                                                    <div align="center">
                                                                        <?php echo $rows['precio_venta'] * $rows['cantidad_venta'];
    $sumar = $sumar + ($rows['precio_venta'] * $rows['cantidad_venta']); ?>
                                                                    </div>
                                                                </td>
                                                                <td>
...
if (!empty($_GET['registrar'])) {
    ...
    echo "<script>location.href='repoteventa.php?cod=$_GET[idven]';</script>";
}
?>